...
```{r}
url3 = "https://actionnetwork.org/users/sign_in"
...
# anorg3_sess_signin = anorg3_sess %>%
#   # session_follow_link("#header_login")
#   html_elements("#header_login") %>% 
#   html_text()
  # # session_
  # session_follow_link()

# anorg3_signin = anorg3_sess %>% 
#   session_follow_link(anorg3_sess_signin)

anorg3_sess

anorgform = html_form(anorg3_sess)[[1]]

filled_form <- html_form_set(anorgform, "user[email]"="jared.garfinkel@gmail.com", "user[password]"="6z!FWcFgv9CBPXv")
